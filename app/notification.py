...
from models import (User, AlertPreference, AlertHistory, Legislation,
...
class NotificationManager:
    ...
    def __init__(self,
        ...
        self.smtp_config = smtp_config or {
            "server":
            os.environ.get("SMTP_SERVER", "smtp.example.com"),
            "port":
            ...
            "from_email":
            os.environ.get("SMTP_FROM", "notifications@policypulse.org"),
        }
    ...
    def process_pending_notifications(self) -> Dict[str, int]:
        ...
        for user in users:
            try:
                ...
                logger.error(
                    f"Error processing notifications for user {user.email}: {e}"
                )
                stats["errors"] += 1
    ...
    def _send_legislation_notification(self, user: User,
        ...
        try:
            ...
            self._send_email(recipient=user.email,
                             subject=subject,
    ...
    def _send_email(self, recipient: str, subject: str,
        ...
        try:
            ...
            with smtplib.SMTP(self.smtp_config["server"],
                ...
                server.starttls()
                if self.smtp_config["username"] and self.smtp_config[
                        "password"]:
